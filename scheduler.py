...
notifications branch); this module only handles the scheduling and the
weather checks.
...
def check_and_alert() -> None:
    ...
    notification module can be supplied by the notifications branch.
    """
    ...
    # Import the notification sender at runtime so that the notifications
...
def run_scheduler() -> None:
    ...
    print(f"Scheduler started. Weather checks will run daily at {check_time} (local time).")
